...
@BotCommand
@CommandPkg(label = "Learning Instance Details", name = "LIDetails",
        description = "Details of a Learning Instance", group_label="Instance",
        node_label = "Learning Instance Details|", icon = "pkg.svg",
